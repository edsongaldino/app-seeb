...
@section('conteudo')
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
     ...
     <a href="{{ route('usuarios.adicionar') }}"><button class="btn btn-incluir"><i class="fa fa-plus"></i> Adicionar usuário</button></a>
    </div>
          ...
          <table class="table table-hover mg-b-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ url('usuario/'.$usuario->id.'/editar') }}"><div class="btn btn-info"><i class="icon ion-edit"></i></div></a>
